...
class CardsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'card_number' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_deleted' => 1,
                'created' => '2021-02-19 13:09:39',
                'modified' => '2021-02-19 13:09:39',
            ],
        ];
        parent::init();
    }
